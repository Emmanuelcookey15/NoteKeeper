...
//        final String queryCourse = "Select * From " + CourseInfoEntry.TABLE_NAME;
//        final Cursor courseCursor = db.rawQuery(queryCourse, null);
...
//        final String queryNote = "Select * From " + NoteInfoEntry.TABLE_NAME;
//        final Cursor noteCursor = db.rawQuery(queryNote, null);
